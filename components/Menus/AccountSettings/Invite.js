          ...
          return (
            <div className={styles.InviteListItem}>
              <div className={styles.InviteListItemInfo}>
                ...
                />
                <p className={styles.InviteListItemInfoName}>{name}</p>
              </div>
              {!validCode ? (
                <Button
                  text="Create Invite"
                ...
                <div className={styles.InviteListItemCode}>
                  <p className={styles.InviteListItemCodeUrl}>{url}</p>
                  <button
                    className={styles.InviteListItemCodeCopy}
                    onClick={() => copyInviteToClipboard(url)}
                  >
                    Copy
                  </button>
                </div>
