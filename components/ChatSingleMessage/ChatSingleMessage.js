...
const ChatSingleMessage = (props) => {
    ...
    const formatMessage = (text) => {
        ...
        const wrappedText = parts.map((part, index) => {
            ...
            if (isURL) {
                const properURL = part.startsWith("www")
                    ? "http://" + part
                    : part;
                return (
                    <a
        ...
        return (
            <div style={{ display: "block", width: "100%" }}>{wrappedText}</div>
        );
    };
                                    ...
                                    !isReportPost && (
                                        <div className={styles.overlay}>
                                            <div className={styles.flagMessage}>
                                                This post has been flagged by a
                                                user as inappropriate.
                                                <br />
                                                Your group's owner can review it
                                                for approval.
                                            </div>
                                        </div>
                                    )}
                    ...
                    <div className={styles.Body}>
                        ...
                        <div className={styles.postWrapper}>
                            ...
                            {flagged && !approvedByAdmin && !isReportPost && (
                                <div className={styles.overlay}>
                                    <div className={styles.flagMessage}>
                                        This post has been flagged by a user as
                                        inappropriate.
                                        <br />
                                        Your group's owner can review it for
                                        approval.
                                    </div>
                                </div>
                            )}
