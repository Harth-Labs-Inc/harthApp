...
const InitialCom = (props) => {
  const { pathname, changePage } = props
  const ComSetupHeader = () => {
    if (pathname === 'comm') {
      return (
        <>
          <svg
          ...
          <p>
            Get started by creating your own h&auml;rth or joining a friends.
            Don't have an invite code? Ask your friends to send you one.
          </p>
        </>
      )
    } else {
      return (
        <p>
          Create your own h&auml;rth or join a friends. Don't have an invite
          code? Ask your friends to send you one.
        </p>
      )
    }
  }
  ...
  return (
    <div id="select-initial-com">
      <ComSetupHeader></ComSetupHeader>
      <div id="initialCom">
        <Button
          text="Create my own h&auml;rth"
          onClick={() => {
            changePage('create')
          }}
        ></Button>
