...
export default async (req, res) => {
  ...
  const deleteConversation = (db, id) => {
  ...
  const deleteConversationMessages = (db, id = "") => {
    return new Promise((resolve, reject) => {
      db.collection("conversation_messages").deleteMany(
  ...
  let deleteResult = await deleteConversation(db, obj.conversation._id);
  let deleteMessagesResults = await deleteConversationMessages(
    db,
