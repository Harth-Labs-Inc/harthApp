    ...
    <div className={styles.TurnKeeper}>
      ...
      <section className={styles.TurnKeeperList}>
        {sortedPeers.map((data, index) => {
          return (
            <div className={styles.TurnKeeperListPeer} key={data.name}>
              <span>
                {index + 1}. {data.name}
              </span>
              <div>
                <button
                  ...
                  onClick={() => changeOrder('up', index, data)}
                ...
                <button
                  ...
                  onClick={() => changeOrder('down', index, data)}
                  disabled={index + 1 === sortedPeers.length ? true : false}
                >
                  move down
                </button>
              </div>
