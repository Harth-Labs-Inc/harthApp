...
export const getComms = async (user, tokenProp) => {
  if (tokenProp) {
    const res = await api.post(
      `/api/comm/getComms`,
      {
...
export const getTopics = async (commId, UserId, tokenProp) => {
  if (tokenProp) {
    const res = await api.post(
      `/api/comm/getTopics`,
      {
...
export const getExistingUnreadMessages = async (id, topicid, tokenProp) => {
  if (tokenProp) {
    const res = await api.post(
