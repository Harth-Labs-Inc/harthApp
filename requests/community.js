...
export const getExistingUnreadMessages = async (id) => {
    try {
        const res = await api.post(`/api/comm/getExistingUnreadMessages`, {
            id,
        });
        return res.data;
    } catch (error) {
...
export const saveUnsavedMessages = async (msg) => {
    try {
        const res = await api.post(`/api/comm/saveUnsavedMessages`, {
            msg,
        });
        return res.data;
    } catch (error) {
